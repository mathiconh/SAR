...
class SprintsDataService {
  ...
  async createSprint({fecha, idCampeonato , idUsuarioP1 , idUsuarioP2 , idVehiculoP1 , idVehiculoP2 , reaccionP1 , reaccionP2 , tiempo100mtsP1 , tiempo100mtsP2 , tiempoLlegadaP1 , tiempoLlegadaP2 , pista , clase}) {
    ...
    result = await http.post(`/createSprint?fecha=${fecha}&idCampeonato=${idCampeonato}&idUsuarioP1=${idUsuarioP1}&idUsuarioP2=${idUsuarioP2}&idVehiculoP1=${idVehiculoP1}&idVehiculoP2=${idVehiculoP2}&reaccionP1=${reaccionP1}&reaccionP2=${reaccionP2}&tiempo100mtsP1=${tiempo100mtsP1}&tiempo100mtsP2=${tiempo100mtsP2}&tiempoLlegadaP1=${tiempoLlegadaP1}&tiempoLlegadaP2=${tiempoLlegadaP2}&pista=${pista}&clase=${clase}&idUsuarioModif=${idUsuarioModif}`);
